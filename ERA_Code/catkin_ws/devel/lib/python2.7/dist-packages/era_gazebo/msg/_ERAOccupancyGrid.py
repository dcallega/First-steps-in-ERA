...
"""autogenerated by genpy from era_gazebo/ERAOccupancyGrid.msg. Do not edit."""
import sys
...
class ERAOccupancyGrid(genpy.Message):
  _md5sum = "3381f2d731d4076ec5c71b0759edbe4e"
  _type = "era_gazebo/ERAOccupancyGrid"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# This represents a custom OccupancyGrid message for map exchanging in ERA.
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ERAOccupancyGrid, self).__init__(*args, **kwds)
